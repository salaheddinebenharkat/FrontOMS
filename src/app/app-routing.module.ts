...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: "airbases",
        loadChildren: () => import('./pages/airbases/airbases.module').then(x=>x.AirbasesModule)
      },
      {
        path: "squadrons",
        loadChildren: () => import('./pages/squadrons/squadrons.module').then(x=>x.SquadronsModule)
      },
      {
        path: "parking",
